...
\end{description}
\end{it}
\include{ai_voorbeschouwing}
\include{ai_layout}
\include{ai_statespaces}
\include{ai_zoekproblemen}
\include{ai_conceptlearning}
\include{ai_constraintprocessing}
\include{ai_gameplaying}
\include{ai_automaticreasoning}
\include{ai_metaheuristics}
\include{ai_machinelearning}
\appendix
\include{ai_appendices}
\newpage
\listoffigures
\newpage
\printindex
